# One-dimensional-Finite-Penetration-Model
The one-dimensional finite penetration model (FEM) is a projectile penetration calculation model designed with the "axial differential - radial analytical" concept, mainly focusing on the macroscopic structural response of the projectile during penetration.
